...
fn main() {
    ...
    let cluster_state = Arc::new(Mutex::new(ClusterState::new(5)));
    background::run(cluster_state.clone());
    ...
    'main: loop {
        ...
        // Instantiate all widgets in the GUI.
        {
            ...
            ui::cluster_view::gui(ui, &mut cluster_state.lock().unwrap());
        }
        ...
        if let Some(primitives) = ui.draw_if_changed() {
            ...
            target.clear_color(0.1, 0.2, 0.15, 1.0);
